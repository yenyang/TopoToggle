// <copyright file="ZoneToolSystemGetAvailableSnapMaskPatch.cs" company="Yenyang's Mods.">
...
namespace TopoToggle.Patches
{
    ...
    /// </summary>
    [HarmonyPatch(typeof(ZoneToolSystem), nameof(ZoneToolSystem.GetAvailableSnapMask),
             new Type[] { typeof(Snap), typeof(Snap) },
             new ArgumentType[] { ArgumentType.Out, ArgumentType.Out })]
    public class ZoneToolSystemGetAvailableSnapMaskPatch
    {
