// <copyright file="WaterToolSystemGetAvailableSnapMaskPatch.cs" company="Yenyang's Mods.">
...
namespace TopoToggle.Patches
{
    ...
    /// </summary>
    [HarmonyPatch(typeof(WaterToolSystem), nameof(WaterToolSystem.GetAvailableSnapMask),
             new Type[] { typeof(Snap), typeof(Snap) },
             new ArgumentType[] { ArgumentType.Out, ArgumentType.Out })]
    public class WaterToolSystemGetAvailableSnapMaskPatch
    {
