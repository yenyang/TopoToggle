// <copyright file="ToolBaseSystemGetAvailableSnapMaskPatch.cs" company="Yenyang's Mods.">
...
namespace TopoToggle.Patches
{
    ...
    /// </summary>
    [HarmonyPatch(typeof(ToolBaseSystem), nameof(ToolBaseSystem.GetAvailableSnapMask),
             new Type[] { typeof(Snap), typeof(Snap) },
             new ArgumentType[] { ArgumentType.Out, ArgumentType.Out })]
    public class ToolBaseSystemGetAvailableSnapMaskPatch
    {
